...
function App() {
  return (
    <>
      <div className="app h-[100vh] bg-appBackground flex flex-col justify-center items-center font-Fraunces">
        <div className="product-review-component bg-reviewComponentBackground grid grid-cols-2 w-[40%] m-auto rounded-md">
          <div className="img rounded-l-md">
            <img src={ProductImage} className="rounded-l-md" alt="Product Image" />
          </div>
          <div className="text-content py-8 px-10 flex flex-col justify-between gap-4">
            ...
            <div className="price flex items-center">
              ...
              <span className="text-darkGrayishBlue line-through ml-6">$169.99</span>
            </div>
